...
var LEVELS = [{
  value: 1,
  label: 'Novice',
  style: _styles_css__WEBPACK_IMPORTED_MODULE_3___default.a.levelNovice
}, {
  value: 2,
  label: 'Beginner',
  style: _styles_css__WEBPACK_IMPORTED_MODULE_3___default.a.levelBeginner
}, {
  value: 3,
  label: 'Skillful',
  style: _styles_css__WEBPACK_IMPORTED_MODULE_3___default.a.levelSkillful
}, {
  value: 4,
  label: 'Experienced',
  style: _styles_css__WEBPACK_IMPORTED_MODULE_3___default.a.levelExperienced
}, {
  value: 5,
  label: 'Expert',
  style: _styles_css__WEBPACK_IMPORTED_MODULE_3___default.a.levelExpert
}];
...
var SkillLevelField = function SkillLevelField(_ref) {
  ...
  return __jsx("div", {
    ...
    className: classnames__WEBPACK_IMPORTED_MODULE_2___default()(_styles_css__WEBPACK_IMPORTED_MODULE_3___default.a.needle, LEVELS[value - 1].style),
    ...
    return __jsx("button", {
      ...
      className: classnames__WEBPACK_IMPORTED_MODULE_2___default()(_styles_css__WEBPACK_IMPORTED_MODULE_3___default.a.level),
      __source: {
        fileName: _jsxFileName,
        lineNumber: 54
      },
...
//# sourceMappingURL=resume-creator.js.a75be8cafa3c687976fe.hot-update.js.map