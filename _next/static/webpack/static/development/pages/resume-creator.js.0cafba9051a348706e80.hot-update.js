...
var SkillLevelField = function SkillLevelField(_ref) {
  ...
  var currentLevel = LEVELS[level.value - 1];

  var moveNeedle = function moveNeedle(value) {
    return {
      transform: "translateX(".concat((value - 1) * 100, "%)")
    };
  };
...
//# sourceMappingURL=resume-creator.js.0cafba9051a348706e80.hot-update.js.map